...
select_button = Button(root, image=select_png, border="0", command=select)
select_button.pack()
...
check_button = Button(root, image=check_png, border="0", command=check)
check_button.pack()
...
flash_button = Button(root, image=flash_png, border="0", command=flash)
flash_button.pack()
